	...
	<div class="container-fluid">
		...
		<div class="container-fluid">
			...
			<div class="col-md-10">
				...
				<c:forEach items="${requestScope.hots}" var="p">
				<div class="col-md-2"
					style="text-align: center; height: 200px; padding: 10px 0px;">
					<a href="${pageContext.request.contextPath}/product?method=getProductByPid&pid=${p.pid}"> <img
						src="${pageContext.request.contextPath}/${p.pimage}"
						width="130" height="130" style="display: inline-block;">
					</a>
					<p>
						<a href="${pageContext.request.contextPath}/product?method=getProductByPid&pid=${p.pid}" style='color: #666'>${p.pname}</a>
					</p>
					<p>
