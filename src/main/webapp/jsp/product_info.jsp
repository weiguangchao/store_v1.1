...
<html>
	...
	<head>
		...
		<script type="text/javascript">
			$(function() {
				// 添加商品到购物车
				$('#addCartItem2Cart').click(function() {
					$('#cartItemFrom').submit();
				})
			})
		</script>
				...
				<div style="margin:0 auto;width:950px;">
					...
					<div class="col-md-6">
						...
						<div style="padding:10px;border:1px solid #e7dbb1;width:330px;margin:15px 0 10px 0;;background-color: #fffee6;">
							...
							<form id="cartItemFrom" action="${pageContext.request.contextPath}/cart?method=addCartItem2Cart" method="post">
								<div style="border-bottom: 1px solid #faeac7;margin-top:20px;padding-left: 10px;">购买数量:
									<input id="quantity" name="quantity" value="1" maxlength="4" size="10" type="text"> </div>
								<input type="hidden" name="pid" value="${product.pid}">
								<div style="margin:20px 0 10px 0;;text-align: center;">
									<a id="addCartItem2Cart" href="javascript:void(0)">
